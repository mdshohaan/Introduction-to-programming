...
ইলিমেন্ট টি এর 0 নাম্বার ইন্ডেক্সে থাকে এবং শেষের ইন্ডেক্স থাকে size-1 নাম্বার ইন্ডেক্সে.
সুতারাং , n সাইজের একটি array এর n তম ইলিমেন্ট এক্সেস করতে হবে arrayName[n-1]
এইভাবে।
*/